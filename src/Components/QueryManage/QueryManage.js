...
import { useGetQueryDataQuery } from "../../feature/api/apiEndPoint/getQueryData";
import "../Style/Style.css";

const QueryManage = () => {
  // redux state

  let { isLoading, data } = useGetQueryDataQuery();
    ...
    <div className="py-16 px-12">
      <div className="flex justify-between items-end gap-3 rounded-2xl  border-gray-200 py-1 px-2">
        <div className="flex justify-center items-center w-7/12 gap-x-4 ">
          ...
          >
            <p className="text-sm">All Query</p> {data?.data?.length}
          </div>
          <div
