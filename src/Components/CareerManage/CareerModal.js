...
const CareerModal = (props) => {
  ...
  useEffect(() => {
    axios
      .get(
        `http://13.127.219.251/backend/backend/api/v1/admin/application/${props.careerId}`
      )
            ...
            <div className="div">
              <div className="flex justify-between  items-center">
                <div className="flex justify-between gap-x-6">
                  ...
                  <p className="flex flex-col text-[16px] text-[#7A7A7A]">
                    ...
                    Last name{" "}
                    <span className="text-[#000000]">
                      {careerResponse?.lastName}
                    </span>
                  </p>
                  <p className="flex flex-col text-[16px] text-[#7A7A7A]">
                    Email{" "}
                    <span className="text-[#000000]">
                      {careerResponse?.email}
                    </span>
                  </p>
                </div>
                ...
                <button
                  ...
                  className="border border-red-500 px-2 py-0 rounded-lg  text-red-500"
                >
                  X
                </button>
              </div>
              ...
              <div className="flex gap-x-14 mt-12">
                <p className="flex flex-col text-[16px] text-[#7A7A7A]">
                  Phone number{" "}
                  <span className="text-[#000000]">
                    {careerResponse?.phone}
                  </span>
                </p>
                <p className="flex flex-col text-[16px] text-[#7A7A7A]">
                  Resume
                  <span
                    onClick={() => onButtonClick(careerResponse?.docUrl)}
                    className="flex justify-start items-center cursor-pointer gap-x-3"
                  >
