    ...
    <div className="px-4 py-8 rounded-lg border m-10 bg-[#FDFDFD]">
      <div className="px-6">
        ...
        <div className="mt-12">
          ...
          <input onChange={handleCareer} type="text" name="jobrole" placeholder="UX UI Designer" className="input input-bordered w-full input-md" />

          <div className="flex justify-start items-center gap-x-12 mt-6">
            <div className="div">
                <h2>Location</h2>
                <input onChange={handleCareer} type="text" placeholder="Bangalore" name="careerlocation" className="input input-bordered input-md w-full max-w-xs"  />
            </div>
            <div className="div">
                <h2>Job Type</h2>
                <input onChange={handleCareer} type="text" placeholder="full time" name="jobtype" className="input input-bordered input-md w-full max-w-xs"  />
            </div>
            <div className="div">
                <h2>Experience Required</h2>
                <input onChange={handleCareer} type="text" placeholder="skill" name="experience" className="input input-bordered input-md w-full max-w-xs"  />
            </div>
          </div>
          ...
          <div className="w-full">
                <h2>Compensation</h2>
                <input onChange={handleCareer} name="compensation" type="text" placeholder="3lpa" className="input input-bordered input-md w-full max-w-xl"  />
            </div>
          <div className="w-full">
                <h2>Start Date</h2>
                
               
        <DatePicker className="input-bordered input input-md w-full max-w-xl"  selected={startDate} onChange={(date) => setStartDate(date)} />
            </div>
          </div>

          <div className="mt-6">
            <h2>Key Resposibilities</h2>
            <textarea onChange={handleCareer} name="keyres" className="textarea textarea-bordered w-full" placeholder="text"></textarea>
          </div>

          <div className="mt-6">
            <h2>Skills Required</h2>
            <input onChange={handleCareer} name="skill" type="text" className="input input-bordered input-md w-full mt-2" />
          </div>
          

          <div className="mt-6">
            <h2>Additional Information (Optional)</h2>
            <textarea onChange={handleCareer} name="additional" className="textarea textarea-bordered w-full" placeholder="text"></textarea>
          </div>
        </div>
      </div>
    </div>
